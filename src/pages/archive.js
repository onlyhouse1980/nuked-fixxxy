import styles from '../styles/archive.module.css';
       ...
       export default function Archive() {
          <div>
            <container>
              <h2 style={{ textAlign: 'center!important' }}><b >OBCG</b><br /><b style={{ textAlign: 'center!important' }}>Minutes Archive</b></h2>
              <p></p>
              <div className={styles.divBlock}>
                <div className={styles.indDates}>
                  ...
                  <button className={styles.button}><a  href='/archive/1998.pdf'>1998</a></button>
                  <button className={styles.button}><a  href='/archive/1997.pdf'>1997</a></button>
                  <button className={styles.button}><a  href='/archive/1996.pdf'>1996</a></button>
                  <button className={styles.button}><a  href='/archive/1995.pdf'>1995</a></button>
                  <button className={styles.button}><a  href='/archive/1994.pdf'>1994</a></button>
                  <button className={styles.button}><a  href='/archive/1993.pdf'>1993</a></button>
                  <button className={styles.button}><a  href='/archive/1992.pdf'>1992</a></button>
                  <button className={styles.button}><a  href='/archive/1991.pdf'>1991</a></button>
                  <button className={styles.button}><a  href='/archive/1990.pdf'>1990</a></button>
