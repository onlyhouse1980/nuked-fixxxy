        ...
        <button className={styles.button}><a target='_blank' href='/archive/1980.pdf'>1980</a></button>    
        <button className={styles.button}><a target='_blank' href='/archive/1979.pdf'>1979</a></button>    
        <button className={styles.button}><a target='_blank' href='/archive/1978.pdf'>1978</a></button>    
        <button className={styles.button}><a target='_blank' href='/archive/1977.pdf'>1977</a></button>    
        <button className={styles.button}><a target='_blank' href='/archive/1976.pdf'>1976</a></button>    
        <button className={styles.button}><a target='_blank' href='/archive/1975.pdf'>1975</a></button>    
        <button className={styles.button}><a target='_blank' href='/archive/1974.pdf'>1974</a></button>    
        </div>
        </div>
